...
const SPECIES = [
  ...
  { id: 'barbo', label: 'Barbo' },
  { id: 'perca', label: 'Perca' },
  { id: 'anguila', label: 'Anguila' },
  { id: 'salmon', label: 'Salmon' },
  { id: 'dorada', label: 'Dorada' },
  { id: 'lubina', label: 'Lubina' },
  { id: 'sargo', label: 'Sargo' },
  { id: 'jurel', label: 'Jurel' },
  { id: 'atun', label: 'Atun' },
];
...
const SPECIES_RULES = {
  ...
  barbo: {
    ...
    tempMax: 24,
    water: ['rio', 'pantano'],
    activeHours: [7, 8, 9, 18, 19],
    gears: ['cebo-natural', 'feeder-fondo', 'boilie-maiz'],
  },
  perca: {
    tempMin: 9,
    tempMax: 20,
    water: ['rio', 'pantano', 'lago'],
    activeHours: [8, 9, 10, 17, 18],
    gears: ['cucharilla', 'vinilo-jig'],
  },
  anguila: {
    tempMin: 14,
    tempMax: 26,
    ...
    gears: ['cebo-natural', 'feeder-fondo'],
  },
  salmon: {
    tempMin: 8,
    tempMax: 17,
    water: ['rio'],
    activeHours: [6, 7, 8, 17, 18],
    gears: ['mosca', 'cucharilla', 'cebo-natural'],
  },
  dorada: {
    tempMin: 13,
    tempMax: 28,
    water: ['mar'],
    activeHours: [7, 8, 9, 18, 19, 20],
    gears: ['cebo-natural', 'surfcasting'],
  },
  lubina: {
    tempMin: 11,
    tempMax: 23,
  ...
  jurel: {
    ...
    tempMax: 27,
    water: ['mar'],
    activeHours: [6, 7, 8, 18, 19, 20],
    gears: ['vinilo-jig', 'currican', 'cebo-natural'],
  },
  atun: {
    tempMin: 16,
    tempMax: 29,
    water: ['mar'],
    activeHours: [7, 8, 9, 10, 17, 18],
    gears: ['currican', 'vinilo-jig'],
  },
};
...
const SPECIES_SEASONS = {
  ...
  barbo: { prime: [4, 5, 6, 9], ok: [3, 7, 8, 10] },
  perca: { prime: [4, 5, 10, 11], ok: [3, 6, 9] },
  anguila: { prime: [6, 7, 8, 9], ok: [5, 10] },
  salmon: { prime: [3, 4, 5, 10, 11], ok: [2, 6, 9] },
  dorada: { prime: [5, 6, 7, 8, 9, 10], ok: [4, 11] },
  lubina: { prime: [10, 11, 12, 1, 2, 3], ok: [4, 9] },
  sargo: { prime: [9, 10, 11, 12, 1, 2], ok: [3, 4, 8] },
  jurel: { prime: [5, 6, 7, 8, 9], ok: [4, 10] },
  atun: { prime: [6, 7, 8, 9, 10], ok: [5, 11] },
};
...
const HARD_INCOMPATIBLE_GEAR = {
  ...
  sargo: ['boilie-maiz', 'vinilo-jig', 'paseante-popper', 'eging', 'currican'],
  atun: ['boilie-maiz', 'feeder-fondo', 'mosca', 'surfcasting', 'eging'],
};

const HARD_INCOMPATIBLE_WATER = {
  // Marinas estrictas
  dorada: ['rio', 'pantano', 'lago', 'agua'],
  sargo: ['rio', 'pantano', 'lago', 'agua'],
  jurel: ['rio', 'pantano', 'lago', 'agua'],
  atun: ['rio', 'pantano', 'lago', 'agua'],
...
const LOCATION_SPECIES_CATALOG = [
  ...
  { keywords: ['embalse de mequinenza', 'mequinenza', 'mar de aragon'], species: ['carpa', 'bass', 'lucio', 'siluro', 'barbo', 'perca'] },
  { keywords: ['embalse de riaño', 'riano'], species: ['trucha', 'carpa', 'lucio', 'perca'] },
  { keywords: ['embalse de alcantara', 'alcántara'], species: ['carpa', 'bass', 'lucio', 'siluro', 'barbo'] },
  { keywords: ['embalse de la serena', 'la serena'], species: ['carpa', 'bass', 'lucio', 'siluro', 'barbo'] },
  { keywords: ['embalse de valdecanas', 'valdecañas'], species: ['carpa', 'bass', 'lucio', 'barbo'] },
  { keywords: ['embalse de iznajar', 'iznajar'], species: ['carpa', 'bass', 'barbo'] },
  { keywords: ['embalse de el atazar', 'atazar'], species: ['carpa', 'bass', 'lucio'] },
  { keywords: ['embalse de santillana', 'santillana'], species: ['carpa', 'bass'] },
  { keywords: ['lago de sanabria', 'sanabria'], species: ['trucha', 'carpa', 'perca'] },
  { keywords: ['lago de banyoles', 'banyoles'], species: ['carpa', 'trucha', 'perca'] },
  { keywords: ['delta del ebro'], species: ['dorada', 'lubina', 'jurel', 'sargo', 'anguila'] },
  { keywords: ['rias baixas', 'rías baixas', 'ria de vigo', 'ría de vigo'], species: ['dorada', 'lubina', 'jurel', 'sargo'] },
  { keywords: ['mar cantabrico', 'cantábrico'], species: ['lubina', 'sargo', 'jurel', 'atun'] },
  { keywords: ['costa del sol', 'costa blanca', 'costa brava', 'costa dorada'], species: ['dorada', 'lubina', 'sargo', 'jurel'] },
  { keywords: ['islas canarias', 'tenerife', 'gran canaria', 'la palma'], species: ['atun', 'jurel', 'dorada', 'lubina'] },
  { keywords: ['rio ebro', 'río ebro'], species: ['carpa', 'bass', 'lucio', 'siluro', 'barbo', 'perca'] },
  { keywords: ['rio tajo', 'río tajo'], species: ['carpa', 'bass', 'lucio', 'trucha', 'barbo'] },
  { keywords: ['rio duero', 'río duero'], species: ['carpa', 'lucio', 'trucha', 'barbo'] },
  { keywords: ['rio guadalquivir', 'río guadalquivir'], species: ['carpa', 'bass', 'barbo', 'anguila'] },
  { keywords: ['rio miño', 'río miño', 'rio mino'], species: ['trucha', 'salmon', 'anguila'] },
  { keywords: ['rio nalon', 'río nalón', 'rio sella', 'río sella'], species: ['trucha', 'salmon'] },
  { keywords: ['rio segura', 'río segura'], species: ['carpa', 'barbo', 'bass'] },
  { keywords: ['rio jucar', 'río júcar', 'rio turia', 'río turia'], species: ['carpa', 'barbo', 'bass'] },
  { keywords: ['rio genil', 'río genil'], species: ['carpa', 'barbo', 'trucha'] },
];
