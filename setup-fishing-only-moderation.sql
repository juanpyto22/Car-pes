-- =====================================================
-- Car-pes: Moderacion exclusiva de pesca + apelaciones
...
-- =====================================================
-- 1) Auditoria de decisiones de moderacion "solo pesca"
-- =====================================================
...
-- Opcional para panel admin basado en perfiles.is_admin
-- Si no tienes is_admin en profiles, borra estas dos politicas.
...
-- =====================================================
-- 3) RPC para enviar apelacion desde frontend
-- =====================================================
...
begin
  ...
  -- Verifica ban activo si existe la tabla user_bans
